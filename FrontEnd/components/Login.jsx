...
function Login({ sendALoginRequest, goToCreateUser }){
    ...
    return <div id='loginBox' className='centerMe'>
        ...
        <form onSubmit={(event) => sendALoginRequest(event, username, password)}>
            ...
            <input type="text" id="username" name="username" onChange={(event) => username = event.target.value}></input>
            <br></br>
            <label >Password:</label>
            <input type="text" id="password" name="password" onChange={(event) => password = event.target.value}></input>
            <br></br>
